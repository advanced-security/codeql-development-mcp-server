...
| `codeql://learning/diff-informed-analysis`       | Make data-flow queries diff-informed and validate with `--check-diff-informed`                                                                                                          |
...
| `codeql://guides/overlay-databases`              | Build and evaluate overlay databases for incremental analysis                                                                                                                           |
